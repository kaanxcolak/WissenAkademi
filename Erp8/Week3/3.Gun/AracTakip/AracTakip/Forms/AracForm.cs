...
namespace AracTakip.Forms
{
    public partial class AracForm : Form
    {
        ...
        private void lstListe_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cmbMarka.SelectedItem = DataContext.Markalar //First hata anında sistemi çalıştırmaz!(Var olduğundan eminiz boş dönmeyeccek!)
                .First(x => x.Id == seciliArac.Model.Marka.Id); //First hatasız direk döndürme durumuna göre konulur ama Find ile hata anında null döndürür
