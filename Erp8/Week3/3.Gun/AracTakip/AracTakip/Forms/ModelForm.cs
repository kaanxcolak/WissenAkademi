...
namespace AracTakip.Forms
{
    public partial class ModelForm : Form
    {
        ...
        private void lstListe_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cmbMarka.SelectedItem = DataContext.Markalar.Find(x => x.Id == model.Marka.Id); //(Find-First=geriye değer döndürür ve function yazar) predicate olanlar;
            //parametresi fonksiyon olan fonksiyonlar-> x=><x.Id //=> lambda expression deriz.
