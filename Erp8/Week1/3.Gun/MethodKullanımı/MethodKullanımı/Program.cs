...
namespace MethodKullanimi
{
    internal class Program
    {
        ...
        //recursive function -  özyinelemeli yani kendi kendini yineliyor
        ...
        static double AlanHesapla(double yaricap, double pi = Math.PI) //gerekli parametreler önce yazılmalı!
        {
            return pi * yaricap * yaricap;
        }

        //ref'li parametreler çağırıldığı yerdeki parametre ile aynı adresi taşıdığından
        //Method içerisinde yapılan değişiklikler çağırıldığı yerdeki parametreye yansır.
