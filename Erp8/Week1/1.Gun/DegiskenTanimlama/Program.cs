...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //signed int aynı zamanda negatif değerleride tutabiliyorken uint sadece 0 ve pozitif değerleri tutar
        ...
        // > < >= <= == != ! işlem  && ||
        // &(Bitwise and) ve &&(Kısa devre ve) arasındaki fark; & hem bitsel hemde mantıksal bir operatör iken && sadece mantıksal operatördür
        // & ifadenin her iki tarafını değerlendirirken, && işleci ise son sonucu ifade etmek için ifadenin yalnızca sol tarafını değerlendirir.
        ...
        string path = @"c:\new\falan.txt"; //@ işareti escape sequances kısmını normal karakter olarak algılanmasını sağlıyor.
